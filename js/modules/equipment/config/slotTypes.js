...
export const SLOT_TYPES = {
    ...
    mainHand: {
        ...
        icon: '🗡️',
        position: { x: 25, y: 50 },
        acceptedCategories: ['weapon', 'armor', 'staff', 'wand', 'rod'],
        acceptedTypes: ['Melee', 'Ranged', 'Shield'],
        acceptedWeaponCategories: ['Semplice', 'Marziale'],
        description: 'Armi, scudi, bastoni, bacchette e verghe',
        maxItems: 1
    },
    ...
    offHand: {
        ...
        description: 'Armi leggere, scudi, bastoni, bacchette e verghe',
        maxItems: 1
    },
...
export const EQUIPMENT_CATEGORY_TO_SLOT = {
    ...
    // Bastoni magici (impugnati come armi)
    'staff': ['mainHand', 'offHand'],
    
    // Bacchette e Verghe magiche (impugnate a una mano)
    'wand': ['mainHand', 'offHand'],
    'rod': ['mainHand', 'offHand'],
...
export function isItemCompatibleWithSlot(slotId, item) {
    ...
    // === BASTONI / BACCHETTE / VERGHE (equipaggiabili come armi) ===
    if (['staff', 'wand', 'rod'].includes(itemCategory)) {
        return slotId === 'mainHand' || slotId === 'offHand';
    }
