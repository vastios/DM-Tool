    ...
    return `
        <div class="inventory-item ${isSelected ? 'selected' : ''} ${isEquipped ? 'equipped' : ''} ${rarityClass} ${!equippable ? 'not-equippable' : ''}"
            ...
            <div class="item-badges">
                ...
                ${needsAttunement ? `
                    <button class="badge attunement-badge ${isAttuned ? 'attuned' : ''} attunement-toggle" 
                            data-action="toggle-attunement" 
                            data-item-index="${index}"
                            title="${isAttuned ? 'Sintonizzato - clicca per rimuovere' : 'Richiede sintonizzazione - clicca per attivare'}">
                        ${isAttuned ? '🔗' : '🔮'}
                    </button>
                ` : ''}
            ...
            <div class="detail-stats">
                ...
                ${needsAttunement ? `
                    <div class="detail-row attunement">
                        ...
                        <button class="detail-attunement-toggle ${item.isAttuned ? 'attuned' : ''}"
                                data-action="toggle-attunement"
                                data-item-index="${item._inventoryIndex ?? ''}"
                                title="${item.isAttuned ? 'Sintonizzato - clicca per rimuovere' : 'Clicca per sintonizzare'}">
                            ${item.isAttuned ? '✅ Attiva' : '🔮 Richiesta'}
                        </button>
                    </div>
                ` : ''}
            </div>
