...
export const spellDatabase = {
    ...
    "Allucinazione mortale": {
        ...
        save: { type: "Sag", success_type: "other" },
        damage: [{ dice: "4d10", type: "danni" }],
        condition: { name: "Spaventato", duration: 10, repeat_save: "end_of_turn" },
    ...
    "Amicizia con gli animali": {
        ...
        save: { type: "Sag", success_type: "other" },
        condition: { name: "Affascinato", duration: 14400 },
        target: { type: "creature", count: 1 },
    },
    "Anatema": {
        name: "Anatema",
        ...
        save: { type: "Car", success_type: "other" },
        target: { type: "creature", count: 3 },
        concentration: true,
    },
    "Animale messaggero": {
    ...
    "Antipatia/Simpatia": {
        ...
        save: { type: "Sag", success_type: "other" },
        condition: { name: "Spaventato", duration: 10 },
        target: { type: "area" },
        area: { shape: "cube", length: 60.0 },
    },
    "Arma magica": {
        name: "Arma magica",
        level: 2,
    ...
    "Aura sacra": {
        ...
        save: { type: "Cos", success_type: "other" },
        condition: { name: "Accecato", duration: 10 },
        target: { type: "self" },
        area: { shape: "sphere", radius: 9.0 },
        concentration: true,
    },
    "Bacche benefiche": {
    ...
    "Bagliore lunare": {
        ...
        save: { type: "Cos", success_type: "half" },
        damage: [{ dice: "2d10", type: "danni" }],
        target: { type: "area" },
        area: { shape: "sphere", radius: 1.5 },
        concentration: true,
    },
    "Bagliore solare": {
    ...
    "Banchetto degli eroi": {
        ...
        save: { type: "Sag", success_type: "other" },
        condition: { name: "Spaventato", duration: 600 },
        target: { type: "creature", count: 1 },
    },
    "Barriera di lame": {
        ...
        save: { type: "Des", success_type: "other" },
        damage: [{ dice: "6d10", type: "danni" }],
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    "Beffa crudele": {
    ...
    "Blocca mostri": {
        ...
        save: { type: "Sag", success_type: "other" },
        condition: { name: "Paralizzato", duration: 10, repeat_save: "end_of_turn" },
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    "Blocca persone": {
    ...
    "Camminare nel vento": {
        ...
        condition: { name: "Inabile", duration: 10 },
        target: { type: "creature", count: 1 },
    },
    ...
    "Campo anti-magia": {
        ...
        condition: { name: "Affascinato", duration: 600 },
        target: { type: "area" },
        concentration: true,
    },
    "Camuffare se stesso": {
    ...
    "Caratteristica potenziata": {
        ...
        condition: { name: "Inabile", duration: 600 },
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    "Carne in pietra": {
        ...
        save: { type: "Cos", success_type: "half" },
        condition: { name: "Pietrificato", duration: 10, repeat_save: "end_of_turn" },
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    "Catena di fulmini": {
        ...
        save: { type: "Des", success_type: "half" },
        damage: [{ dice: "10d8", type: "fulmine" }],
        target: { type: "creature", count: 1 },
    },
    "Cecità/Sordità": {
        name: "Cecità/Sordità",
        ...
        save: { type: "Cos", success_type: "other" },
        condition: { name: "Accecato", duration: 10, repeat_save: "end_of_turn" },
        target: { type: "creature", count: 1 },
    },
    "Celare": {
        name: "Celare",
    ...
    "Cerchio di morte": {
        ...
        save: { type: "Cos", success_type: "half" },
        damage: [{ dice: "8d6", type: "danni" }],
        target: { type: "area" },
        area: { shape: "sphere", radius: 18.0 },
    },
    ...
    "Chiaroveggenza": {
        ...
        condition: { name: "Invisibile", duration: 100 },
        target: { type: "area" },
        concentration: true,
    },
    "Clone": {
    ...
    "Colpo infuocato": {
        ...
        save: { type: "Des", success_type: "half" },
        damage: [{ dice: "4d6", type: "fuoco" }, { dice: "4d6", type: "danni" }],
        target: { type: "area" },
        area: { shape: "sphere", radius: 3.0 },
    },
    "Comando": {
        ...
        save: { type: "Sag", success_type: "other" },
        condition: { name: "Prono", duration: 1 },
        target: { type: "creature", count: 1 },
    },
    ...
    "Compulsione": {
        ...
        save: { type: "Sag", success_type: "other" },
        condition: { name: "Affascinato", duration: 10 },
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    "Comunione": {
    ...
    "Cono di freddo": {
        ...
        save: { type: "Cos", success_type: "half" },
        damage: [{ dice: "8d8", type: "freddo" }],
        target: { type: "area" },
        area: { shape: "cone", radius: 18.0 },
    },
    ...
    "Contagio": {
        ...
        save: { type: "Cos", success_type: "other" },
        condition: { name: "Stordito", repeat_save: "end_of_turn" },
        target: { type: "creature", count: 1 },
    },
    "Contattare altri piani": {
        ...
        save: { type: "Int", success_type: "other" },
        damage: [{ dice: "6d6", type: "danni" }],
        target: { type: "self" },
    },
    "Contingenza": {
        name: "Contingenza",
    ...
    "Controllare acqua": {
        ...
        save: { type: "For", success_type: "other" },
        damage: [{ dice: "2d8", type: "danni" }, { dice: "2d8", type: "danni" }],
        target: { type: "area" },
        area: { shape: "cube", length: 30.0 },
        concentration: true,
    },
    ...
    "Costrizione": {
        ...
        save: { type: "Sag", success_type: "other" },
        damage: [{ dice: "5d10", type: "danni" }],
        condition: { name: "Affascinato" },
        target: { type: "creature", count: 1 },
    },
    "Creare cibo e acqua": {
    ...
    "Crescita di spine": {
        ...
        damage: [{ dice: "2d4", type: "danni" }],
        target: { type: "area" },
        area: { shape: "sphere", radius: 6.0 },
        concentration: true,
    },
    "Crescita vegetale": {
    ...
    "Disintegrazione": {
        ...
        save: { type: "Des", success_type: "other" },
        damage: [{ dice: "10d6+40", type: "forza" }],
        target: { type: "area" },
        area: { shape: "cube", length: 3.0 },
    },
    ...
    "Dominare bestie": {
        ...
        save: { type: "Sag", success_type: "other" },
        condition: { name: "Affascinato", duration: 100 },
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    "Dominare mostri": {
        ...
        save: { type: "Sag", success_type: "other" },
        condition: { name: "Affascinato", duration: 4800 },
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    "Dominare persone": {
    ...
    "Fondersi nella pietra": {
        ...
        damage: [{ dice: "6d6", type: "danni" }],
        condition: { name: "Prono", duration: 4800 },
        target: { type: "creature", count: 1 },
    },
    "Forma eterea": {
        name: "Forma eterea",
    ...
    "Forma gassosa": {
        ...
        save: { type: "For", success_type: "half" },
        condition: { name: "Stordito", duration: 600 },
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    "Forme animali": {
        ...
        condition: { name: "Svenuto", duration: 14400 },
        target: { type: "area" },
        concentration: true,
    },
    "Frantumare": {
    ...
    "Freccia acida": {
        ...
        damage: [{ dice: "4d4", type: "acido" }, { dice: "2d4", type: "acido" }],
        target: { type: "creature", count: 1 },
    },
    "Fulmine": {
        name: "Fulmine",
        ...
        save: { type: "Des", success_type: "other" },
        damage: [{ dice: "8d6", type: "fulmine" }],
        target: { type: "area" },
        area: { shape: "line", length: 30.0 },
    },
    "Fuorviare": {
        name: "Fuorviare",
        level: 5,
        ...
        condition: { name: "Invisibile", duration: 600 },
        target: { type: "self" },
        concentration: true,
    },
    "Gabbia di forza": {
    ...
    "Guardiani spirituali": {
        ...
        save: { type: "Sag", success_type: "other" },
        damage: [{ dice: "3d8", type: "danni" }, { dice: "3d8", type: "danni" }],
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    ...
    "Ingrandire/Ridurre": {
        ...
        save: { type: "Cos", success_type: "other" },
        damage: [{ dice: "1d4", type: "danni" }, { dice: "1d4", type: "danni" }],
        target: { type: "area" },
        concentration: true,
    },
    "Insetto gigante": {
    ...
    "Intralciare": {
        ...
        save: { type: "For", success_type: "other" },
        condition: { name: "Trattenuto", duration: 10 },
        target: { type: "area" },
        concentration: true,
    },
    ...
    "Invisibilità superiore": {
        ...
        condition: { name: "Invisibile", duration: 10 },
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    "Invocare il fulmine": {
    ...
    "Mano arcana": {
        ...
        damage: [{ dice: "2d6", type: "danni" }, { dice: "4d8", type: "forza" }],
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    "Mano magica": {
    ...
    "Metamorfosi": {
        ...
        save: { type: "Sag", success_type: "other" },
        condition: { name: "Svenuto", duration: 600 },
        target: { type: "area" },
        concentration: true,
    },
    "Metamorfosi pura": {
    ...
    "Modificare memoria": {
        ...
        save: { type: "Sag", success_type: "half" },
        condition: { name: "Affascinato", duration: 100 },
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    ...
    "Muro di fuoco": {
        ...
        save: { type: "Des", success_type: "half" },
        damage: [{ dice: "5d8", type: "fuoco" }, { dice: "5d8", type: "fuoco" }],
        target: { type: "area" },
        concentration: true,
    },
    "Muro di ghiaccio": {
        ...
        save: { type: "Des", success_type: "half" },
        damage: [{ dice: "10d6", type: "freddo" }, { dice: "5d6", type: "freddo" }],
        target: { type: "area" },
        concentration: true,
    },
    "Muro di pietra": {
    ...
    "Muro di spine": {
        ...
        save: { type: "Des", success_type: "half" },
        damage: [{ dice: "7d8", type: "danni" }, { dice: "7d8", type: "danni" }],
        target: { type: "area" },
        concentration: true,
    },
    "Muro di vento": {
    ...
    "Muro prismatico (COLORI)": {
        ...
        save: { type: "Cos", success_type: "half" },
        damage: [{ dice: "10d6", type: "fuoco" }, { dice: "10d6", type: "acido" }, { dice: "10d6", type: "fulmine" }, { dice: "10d6", type: "veleno" }, { dice: "10d6", type: "freddo" }],
        condition: { name: "Pietrificato", duration: 100, repeat_save: "end_of_turn" },
        target: { type: "creature", count: 1 },
    },
    "Carne in pietra": {
        name: "Carne in pietra",
    ...
    "Parola del potere stordire": {
        ...
        save: { type: "Cos", success_type: "other" },
        condition: { name: "Stordito", duration: 10, repeat_save: "end_of_turn" },
        target: { type: "creature", count: 1 },
    },
    ...
    "Parola divina": {
        ...
        save: { type: "Car", success_type: "other" },
        condition: { name: "Stordito", duration: 10 },
        target: { type: "area" },
    },
    ...
    "Sciame di meteore": {
        ...
        save: { type: "Des", success_type: "half" },
        damage: [{ dice: "20d6", type: "fuoco" }, { dice: "20d6", type: "danni" }],
        target: { type: "area" },
        area: { shape: "sphere", radius: 12.0 },
    },
    "Scolpire pietra": {
    ...
    "Scudo": {
        ...
        condition: { name: "Affascinato", duration: 1 },
        target: { type: "self" },
    },
    "Scudo della fede": {
    ...
    "Scudo di fuoco": {
        ...
        damage: [{ dice: "2d8", type: "fuoco" }, { dice: "2d8", type: "freddo" }],
        target: { type: "self" },
        area: { shape: "sphere", radius: 3.0 },
    },
    "Scurovisione": {
    ...
    "Segugio fedele": {
        ...
        damage: [{ dice: "4d8", type: "danni" }],
        condition: { name: "Invisibile", duration: 4800 },
        target: { type: "area" },
    },
    "Sembrare": {
        name: "Sembrare",
    ...
    "Silenzio": {
        ...
        condition: { name: "Assordato", duration: 100 },
        target: { type: "area" },
        area: { shape: "sphere", radius: 6.0 },
        concentration: true,
    },
    "Simbolo": {
        ...
        save: { type: "Cos", success_type: "half" },
        damage: [{ dice: "10d10", type: "danni" }],
        condition: { name: "Stordito", duration: 100 },
        target: { type: "area" },
    },
    "Simulacro": {
        name: "Simulacro",
    ...
    "Sonno": {
        ...
        condition: { name: "Svenuto", duration: 10 },
        target: { type: "area" },
    },
    "Spada arcana": {
        name: "Spada arcana",
    ...
    "Spruzzo colorato": {
        ...
        condition: { name: "Accecato", duration: 1 },
        target: { type: "area" },
        area: { shape: "cone", radius: 4.5 },
    },
    "Spruzzo prismatico": {
        ...
        save: { type: "Des", success_type: "half" },
        damage: [{ dice: "10d6", type: "fuoco" }, { dice: "10d6", type: "acido" }, { dice: "10d6", type: "fulmine" }, { dice: "10d6", type: "veleno" }, { dice: "10d6", type: "freddo" }],
        condition: { name: "Pietrificato", repeat_save: "end_of_turn" },
        target: { type: "area" },
        area: { shape: "cone", radius: 18.0 },
    },
    "Stretta folgorante": {
    ...
    "Telecinesi": {
        ...
        condition: { name: "Trattenuto", duration: 100 },
        target: { type: "creature", count: 1 },
        concentration: true,
    },
    "Tempesta di nevischio": {
        ...
        save: { type: "Des", success_type: "other" },
        condition: { name: "Prono", duration: 10 },
        target: { type: "area" },
        area: { shape: "sphere", radius: 12.0 },
        concentration: true,
    },
    "Tempesta di vendetta": {
        ...
        save: { type: "Cos", success_type: "half" },
        damage: [{ dice: "2d6", type: "tuono" }, { dice: "1d6", type: "acido" }, { dice: "10d6", type: "fulmine" }, { dice: "2d6", type: "danni" }, { dice: "1d6", type: "freddo" }],
        condition: { name: "Assordato", duration: 50 },
        target: { type: "area" },
        area: { shape: "sphere", radius: 110.0 },
        concentration: true,
    },
    "Tentacoli neri": {
        name: "Tentacoli neri",
        ...
        save: { type: "Des", success_type: "other" },
        damage: [{ dice: "3d6", type: "danni" }, { dice: "3d6", type: "danni" }],
        condition: { name: "Trattenuto", duration: 10 },
        target: { type: "creature", count: 1 },
        concentration: true,
    },
